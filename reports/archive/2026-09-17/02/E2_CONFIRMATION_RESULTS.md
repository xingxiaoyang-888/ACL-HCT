...
另行固定无图MLP能力对照已完成：两seed的最佳valid micro MRR为0.020537/0.019144，均高于原GNN的0.017537/0.013929；详见[E2_CAPACITY_RESULTS.md](../03/E2_CAPACITY_RESULTS.md)。这使原GNN具有相对该有界文本参照的检索优势这一前提不成立。确认仍照原登记完整保留，不能因能力结果删除条件；但不应将弱模型上的采样损伤升级为有竞争力骨干的普遍坍缩证据。
