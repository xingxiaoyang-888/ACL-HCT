...
本轮用户授权与主管协议见 [匹配编码器协议](../../../../docs/operations/E2_MATCHED_ENCODER_CONTROL.md) 和 [主线决策](../history/03_主线证据与下一步决策.md)。本交付未提交Git、未申请GPU、未打开真实prepared或检查点、未进行真实模型训练；实际2.5.1预检和CUDA门等待主管接收固定版本后由实验任务执行。
